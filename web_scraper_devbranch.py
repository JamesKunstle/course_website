...
def print_course_data(input_url, low_bound, high_bound):
    pages = []
    for i in range(low_bound, high_bound + 1):
        local_url = input_url + str(i)
        pages.append(get_course_data(local_url))
...
print_course_data(cs_catalog_pages_url, 1, 3)
